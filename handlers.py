...
def get_main_keyboard():
    keyboard = [
        [KeyboardButton("Пополнить игровой баланс")],
        [KeyboardButton("Вывод"), KeyboardButton("Новостной канал")],
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text in ["Пополнить игровой баланс", "Вывод"]:
        ...
        await update.message.reply_text("Ссылка на новостной канал будет добавлена в ближайшее время.")
